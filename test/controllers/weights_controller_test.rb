...
class WeightsControllerTest < ActionController::TestCase
  ...
  test "should create weight" do
    assert_difference('Weight.count') do
      post :create, weight: { exercise: @weight.exercise, notes: @weight.notes, reps: @weight.reps, sets: @weight.sets, weight: @weight.weight }
    end
  ...
  test "should update weight" do
    patch :update, id: @weight, weight: { exercise: @weight.exercise, notes: @weight.notes, reps: @weight.reps, sets: @weight.sets, weight: @weight.weight }
    assert_redirected_to weight_path(assigns(:weight))
  end
